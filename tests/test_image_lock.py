...
class ImageLockTests(unittest.TestCase):
    ...
    def test_lock_records_public_source_heads_and_partial_artifacts(self) -> None:
        ...
        self.assertEqual(
            ...
            {
                "head": "sha256:1a015149724c6d246c6ad92c539c32838d9131d6f9b7758202abac36b3fc758e",
                "worker": "sha256:a84d322dbcae2e9f2542a8501139239ac2df407b5f302166fea2fb6e9b3d90ad",
            },
        )
        self.assertEqual(
            ...
            {
                "head": None,
                "worker": "candidate/dsv4-native432-dspark5@sha256:a84d322dbcae2e9f2542a8501139239ac2df407b5f302166fea2fb6e9b3d90ad",
            },
        )
