...
ACTION="${1:---preflight}"
ROLE=worker
EXPECTED_HOST=spark-1db1
CONTAINER=dsv4-native432-lmcache-worker
IMAGE_ID=sha256:cfda698594440294c1c08e448621b15233ea57028529f388e2d86edd069e931f
...
CONTRACT_PATH=/home/lutongzzz/.cache/dgx-spark-tests/nonflash-327k-rollout-20260902T022533Z/deployment/repo-managed-production/contracts/production-worker.json
ENV_PATH=/home/lutongzzz/.cache/dgx-spark-tests/nonflash-327k-rollout-20260902T022533Z/deployment/repo-managed-production/contracts/production-worker.env
...
CREATE=(
  ...
  --env
  DGX_SPARK_FABRIC_CIDR=192.168.100.11/24
  --env
  DGX_SPARK_FABRIC_PEER=192.168.100.10
  --env
  ...
  --env-file
  /home/lutongzzz/.cache/dgx-spark-tests/nonflash-327k-rollout-20260902T022533Z/deployment/repo-managed-production/contracts/production-worker.env
  --mount
  type=bind,src=/home/lutongzzz/models/DeepSeek-V4-Flash-0731,dst=/models/DeepSeek-V4-Flash-0731,readonly
  --mount
  type=bind,src=/home/lutongzzz/.cache/dgx-spark-tests/nonflash-327k-rollout-20260902T022533Z/cache/dgx1/vllm,dst=/root/.cache/vllm
  --mount
  type=bind,src=/home/lutongzzz/.cache/dgx-spark-tests/nonflash-327k-rollout-20260902T022533Z/cache/dgx1/b12x,dst=/root/.cache/b12x
  --mount
  type=bind,src=/home/lutongzzz/.cache/dgx-spark-tests/nonflash-327k-rollout-20260902T022533Z/cache/dgx1/flashinfer,dst=/root/.cache/flashinfer
  --mount
  type=bind,src=/home/lutongzzz/.cache/dgx-spark-tests/nonflash-327k-rollout-20260902T022533Z/cache/dgx1/triton,dst=/root/.triton
  --mount
  type=bind,src=/home/lutongzzz/.cache/dgx-spark-tests/nonflash-327k-rollout-20260902T022533Z/cache/dgx1/tilelang,dst=/root/.tilelang
  --mount
  type=bind,src=/home/lutongzzz/.cache/dgx-spark-tests/nonflash-327k-rollout-20260902T022533Z/deployment/repo-managed-production/contracts/production-worker.json,dst=/etc/dgx-spark/service-contract.json,readonly
  "$IMAGE_ID"
  vllm
  serve
